...
DATABASES = {
    'default': {
        ...
        'INSTANCE': 'tellme-production-db:tellme-db',
        'NAME': 'prototype',
}
}
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'core.context_processors.usernames',
)
...
INSTALLED_APPS = (
    ...
    #'django.contrib.sites', #jeff removed this to fix django_sites table in cloud sql
...
if ON_PRODUCTION:
    ...
    EMAIL_FROM = "djtrack16@gmail.com"
else:
