...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('books_book', (
            ...
            ('last_update_date', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('books', ['Book'])

        # Adding model 'Entry'
        db.create_table('books_entry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('books', ['Entry'])
